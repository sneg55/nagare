...
export default function Reference() {
  return (
    <>
      ...
      <p>
        The whole path has run on mainnet: listed, offered against twice, accepted, withdrawn
        from by the buyer, and the escrow behind the expired offer reclaimed under the key
        that made it.
      </p>
